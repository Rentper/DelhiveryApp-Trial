    ...
    <div className=" h-[668px] border w-96 m-auto ">
      <div className=" ">
        ...
        <div className=" mt-3  scroll-auto overflow-y-auto    h-[360px]  ">
          <div className="border mt-2 p-0.5  shadow-[0_0px_5px_rgba(0,0,0,0.25)] rounded-md m-auto  text-xs w-[370px] flex h-[70px]  ">
            <div className="w-64">
              <p className="text-gray-400 text-xs pl-1 ">Location</p>
              <p className="text-base mt-2 pl-1  "> Nanakhed, Ujjain </p>
            </div>
            <div className=" ">
              <p className="ml-4 ">|</p>
              <p className="text-[10px]">250km</p>
            ...
            <div className="w-64 ">
              ...
              <p className="text-base mt-2  ">Freeganj Ujjain</p>
            </div>
          </div>
